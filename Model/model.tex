...
By substituting $\Lambda_{\mathrm{UV}} = M_{\mathrm{pl}}$ in Eqs.~\eqref{eq:delmh_f} and \eqref{eq:delmh_S} and assuming $\lambda_f \sim \lambda_S \sim \mathcal{O} (1)$, we notice that orders-of-magnitude fine-tuning is required to obtain the correct Higgs mass $m_h = 125.09\,\mathrm{GeV}$ \cite{Tanabashi:2018oca}, which is unnatural.
...
\footnote{
  ...
  The latest central values of the Higgs and top masses are $M_h = 125.09\,\mathrm{GeV}$ and $M_t = 173.1\,\mathrm{GeV}$, with which we can estimate $\lambda (M_t) = 0.12593$.
}
\begin{align}
  \lambda (M_t) = 0.12604
