...
\begin{figure}[t]
  ...
  \caption{Invariant mass distribution of the pair-produced electrons at a $100\,\mathrm{TeV}$ collider with the integrated luminosity $\mathcal{L} = 3\,\mathrm{ab}^{-1}$.
  \rem{Change figure to $3\,\mathrm{ab}^{-1}$}}
  \label{fig:histMee}
\end{figure}
...
\begin{figure}[t]
  ...
  \caption{
    ...
    \textit{(Left):} The figure for Higgsino.
