...
Note that this ratio remains unchanged even if we take into account the next-to-leading order (NLO) QCD effect because the EWIMPs affect the cross sections only through the vacuum polarization.
\footnote{
...
We take into account the NLO QCD effect by the \verb|[QCD]| option of \verb|MadGraph5_aMC@NLO| since it enhances the cross section roughly by a factor of $2$ compared to the LO calculation.
\footnote{
%%
...
\rem{Comment on bound state effect somewhere}
