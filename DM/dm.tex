...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.7\hsize]{si_2.pdf}
  \caption{
    Current constraints on the DM SI cross section taken from \cite{Schumann:2019eaa}.
    The $y$-axis corresponds to $\sigma_p^{\mathrm{SI}}$ in our notation.
  }
  \label{fig:SI}
\end{figure}

In Fig.~\ref{fig:SI}, we show the current constraints on the DM SI scattering cross section $\sigma_p^{\mathrm{SI}}$ as a function of its mass.
See \cite{Schumann:2019eaa} and references therein for the details of each experiment.
...
Besides, the future planned experiments such as PandaX-4T \cite{Zhang:2018xdp}, XENONnT \cite{Aprile:2015uzo}, LZ \cite{Akerib:2018dfk}, and DarkSide-20k \cite{Aalseth:2017fik} will be able to probe the spin-independent cross section of $\mathcal{O}(10^{-48})\,\mathrm{cm}^2$ at the sensitivity maximum after a few years of data taking.

The qualitative description of the form of the sensitivity curves in Fig.~\ref{fig:SI} can be given using the above discussion.
