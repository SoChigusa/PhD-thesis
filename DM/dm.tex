...
Equivalently, this effect can be seen as the deformation of the two-DM wave function from the plane wave according to the potential energy between them caused by the electroweak interaction.
...
% \rem{NOT suitable for line spectrum??}
...
% From the figure, we can see that the current constraint of the thermally produced DM is on $m_\chi \lesssim 100\,\mathrm{GeV}$, while the future prospect of the observations of the Galactic Center and dwarf galaxies play complementary roles with each other and cover a large region around $m_\chi \sim 1\,\mathrm{TeV}$ and below.
