...
The same calculation applies to the MDMs with $n \geq 5$, $Y=0$, and $\Delta m = 166\, \mathrm{MeV}$, resulting in somewhat shorter flight length that scales as $c \tau \sim 44\, \mathrm{cm} / (n^2 - 1)$ irrespective of the MDM spin \cite{Cirelli:2005uq} due to the stronger interaction with $W$ bosons.
